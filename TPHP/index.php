    ...
    <table class="table table-striped">
        ...
        foreach ($lignes as $l){
            ...
            <tr>
                ...
                <td><?php echo htmlentities($l["resultat"])?></td>
                <td>
                    <a href="herbier_draw.php?d=<?php echo $l["resultat"]?>" class="btn btn-success"&>Voir</a>
                    <a href="action/supprimer.php?id=<?php echo $l["id"]?>" class="btn btn-danger">Supprimer</a>
                </td>
            </tr>
            <?php
        }
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="donnees" name="donnees" pattern="[0-9]/[0-9]/[0-9]/[0-9]/[0-9]/[0-9]/[0-9]/[0-9]/[0-9]" required>
                </div>
